...
sudo cp -f "$REMOTEIO_DIR/$REMOTEIO_DIR/remoteio_server.py" "$INSTALL_DIR/remoteio_server.py"
sudo cp -f "$REMOTEIO_DIR/$REMOTEIO_DIR/remoteio_client.py" "$INSTALL_DIR/remoteio_client.py"
